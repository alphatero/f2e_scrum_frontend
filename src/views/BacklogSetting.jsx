...
import { BacklogSettingInfo } from '../constants/backlogSettingInfo';

function BacklogSetting() {
  const navigate = useNavigate();
  const { tasks, button } = BacklogSettingInfo;
  ...
  return (
    <div className="p-4">
      ...
      <div className="border border-zinc-800 rounded-lg p-3 h-[40vh]">
        {/* drag to here */}
      </div>
