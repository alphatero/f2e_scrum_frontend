    ...
    >
      <div className="relative px-4 flex max-w-5xl mx-auto">
        ...
        <div className="absolute right-0 bottom-0 object-contain flex">
          <img src="/images/introduction-scrum-rabbit.png" alt="guide" />
        </div>
      </div>
      <BlurBlockBg type="A">
        <div
        ...
        >
          <article className="flex flex-col w-full px-5 md:p-10">
            ...
            {article.map((word) =>
              word.type === 'bold' && Array.isArray(word.content) ? (
                ...
                <p
                  key={word.id}
                  className="py-2 text-sm md:text-base whitespace-pre-wrap"
                >
                  {word.content}
                </p>
              ),
            ...
            (image.type === 'img' ? (
              <div>
                <img
                  ...
                  alt="圖片來源. 新加坡鈦坦科技-Scrum"
                />
                <a
                  href={image.reference}
                  className="text-teal-500 underline text-xs"
                >
                  圖片來源. 新加坡鈦坦科技-Scrum
                </a>
              </div>
